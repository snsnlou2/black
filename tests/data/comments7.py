...
from .config import Any, Bool, ConfigType, ConfigTypeAttributes, Int, Path
from .config import Any, Bool, ConfigType, ConfigTypeAttributes, Int, no_comma_here_yet
...
def func():
    c = call(0.0123, 0.0456, 0.0789, 0.0123, 0.0789, a[(- 1)])
    c = call(0.0123, 0.0456, 0.0789, 0.0123, 0.0789, a[(- 1)])
    c = call(0.0123, 0.0456, 0.0789, 0.0123, 0.0456, 0.0789, 0.0123, 0.0456, 0.0789, a[(- 1)])
    c = call('aaaaaaaa', 'aaaaaaaa', 'aaaaaaaa', 'aaaaaaaa', 'aaaaaaaa', 'aaaaaaaa', 'aaaaaaaa', 'aaaaaaaa', 'aaaaaaaa', 'aaaaaaaa', 'aaaaaaaa', 'aaaaaaaa')
