...
addition_inside_tuple = ((some_string_inside_a_variable + 'Some string that is just long enough to cause a split to take place.............'), xyz, ("Some really long string that needs to get split eventually but I'm running out of things to say" + some_string_inside_a_variable))
addition_inside_tuple = (some_string_inside_a_variable + 'Some string that is just long enough to cause a split to take place..............')
return 'Hi there. This is areally really reallllly long string that needs to be split!!!'
ternary_expression = ('Short String' if some_condition else 'This is a really long string that will eventually need to be split right here.')
