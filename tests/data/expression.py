...
call(this_is_a_very_long_variable_which_will_force_a_delimiter_split, arg, another, kwarg='hey', **kwargs)
call(*gidgets[:2])
call(a, *gidgets[:2])
...
tuple[(str, int, float, dict[(str, int)])]
xxxx_xxxxx_xxxx_xxx = classmethod(sync(async_xxxx_xxx_xxxx_xxxxx_xxxx_xxx.__func__))
xxxx_xxx_xxxx_xxxxx_xxxx_xxx = classmethod(sync(async_xxxx_xxx_xxxx_xxxxx_xxxx_xxx.__func__))
xxxx_xxx_xxxx_xxxxx_xxxx_xxx = classmethod(sync(async_xxxx_xxx_xxxx_xxxxx_xxxx_xxx.__func__))
slice[0]
slice[0:1]
slice[0:1:2]
...
if (((threading.current_thread() != threading.main_thread()) and (threading.current_thread() != threading.main_thread())) or (signal.getsignal(signal.SIGINT) != signal.default_int_handler)):
    return True
if (aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa | aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa):
    return True
if (aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa & aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa):
    return True
if (aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa + aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa):
...
if (aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa / aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa):
    return True
if ((((~ aaaa.a) + aaaa.b) - ((aaaa.c * aaaa.d) / aaaa.e)) | ((aaaa.f & (aaaa.g % aaaa.h)) ^ ((aaaa.i << aaaa.k) >> ((aaaa.l ** aaaa.m) // aaaa.n)))):
    return True
if ((((~ aaaaaaaa.a) + aaaaaaaa.b) - ((aaaaaaaa.c @ aaaaaaaa.d) / aaaaaaaa.e)) | ((aaaaaaaa.f & (aaaaaaaa.g % aaaaaaaa.h)) ^ ((aaaaaaaa.i << aaaaaaaa.k) >> ((aaaaaaaa.l ** aaaaaaaa.m) // aaaaaaaa.n)))):
    return True
if ((((~ aaaaaaaaaaaaaaaa.a) + aaaaaaaaaaaaaaaa.b) - ((aaaaaaaaaaaaaaaa.c * aaaaaaaaaaaaaaaa.d) @ aaaaaaaaaaaaaaaa.e)) | ((aaaaaaaaaaaaaaaa.f & (aaaaaaaaaaaaaaaa.g % aaaaaaaaaaaaaaaa.h)) ^ ((aaaaaaaaaaaaaaaa.i << aaaaaaaaaaaaaaaa.k) >> ((aaaaaaaaaaaaaaaa.l ** aaaaaaaaaaaaaaaa.m) // aaaaaaaaaaaaaaaa.n)))):
    return True
last_call()
...
'some_string'
