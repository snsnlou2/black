...
from typing import Generator, List, Literal, NamedTuple, Optional, Tuple, Union, cast
...
def download_and_extract_top_packages(directory, days=365, workers=8, limit=DEFAULT_SLICE):
